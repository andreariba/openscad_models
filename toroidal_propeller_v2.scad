...
function rotated_foil(rotation,angle) = [
    for (i = [0:len(2032c_points)-1])
        (0.003*cos(angle)*cos(angle)+0.003)*[[cos(rotation),0,-sin(rotation)],[0,1,0],[sin(rotation),0,cos(rotation)]]*[2032c_points[i][0]-500,0, 2032c_points[i][1]] + 10*[cos(angle),sin(angle),0]
];
